...
# WireGuard VPN一键安装脚本
# 版本: 2.0
# GitHub: https://github.com/fengwan065-prog/VPN.git
...
show_banner() {
    ...
    echo "   GitHub: https://github.com/fengwan065-prog/VPN.git"
    echo "================================================="
    echo -e "${NC}"
}
...
install_dependencies() {
    ...
    # 安装其他必要工具
    $PKG_MANAGER install -y https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm && $PKG_MANAGER install -y qrencode
